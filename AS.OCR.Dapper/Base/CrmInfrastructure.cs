...
namespace AS.OCR.Dapper.Base
{
    ...
    public class CrmInfrastructure<T> : BaseInterFace<T> where T : class
    {
        /// <summary>
        /// 增
        /// </summary>
        ...
        /// <returns></returns>
        public bool Add(T Entity) => CrmDBContext.Add(Entity) == 0 ? true : false;
        /// <summary>
        /// 删
        /// </summary>
        /// <param name="Entity"></param>
        /// <returns></returns>
        public bool Delete(T Entity) => CrmDBContext.Delete(Entity);
        /// <summary>
        /// 改
        /// </summary>
        /// <param name="Entity"></param>
        /// <returns></returns>
        public bool Update(T Entity) => CrmDBContext.Update(Entity);
        ...
        /// <param name="whereStr"></param>
        /// <returns></returns>
        public S GetModelFromSql<S>(string sql) => CrmDBContext.QueryFirstOrDefault<S>(sql);
        ...
        /// <param name="whereStr"></param>
        /// <returns></returns>
        public List<S> GetListFromSql<S>(string sql) => CrmDBContext.Query<S>(sql).ToList();
